...
module.exports = function(app){
  ...
  // CHECK USER ROUTE =====================
  // =====================================
  app.get('/api/checkusername/:username', function (req, res) {
  ...
  app.get("/api/:id/search/:username", isLoggedIn, function (req, res) {
  ...
  app.get('/api/getDetail/:id',isLoggedIn,function (req, res) {
  ...
  app.get('/api/:id/getmsg/:rid/:msgid',isLoggedIn,function (req, resp) {
  ...
  app.get('/api/getWord/:sid/:rid/:word', function (req, res) {
  ...
  app.get('/api/getWord/:sid/:rid/:word/:start/:end', function (req, res) {
  ...
  app.post("/api/status/:id",isLoggedIn,(req,res)=>
{
...
app.post('/api/dp/:id',isLoggedIn,(req,res)=>{
